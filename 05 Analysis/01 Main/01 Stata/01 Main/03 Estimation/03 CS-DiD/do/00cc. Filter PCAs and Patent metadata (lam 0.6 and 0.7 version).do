...
* ==============================================================================
    ...
    ** Get grant date of controls
    ...
    save "C:\Users\amusali\Desktop\uc3m PhD\05 Analysis\01 Main\01 Stata\01 Main\01 Data load\00 Patents\dta\01 Patent data - without citations - only matched records - no exact match on grant year (lam 0.6 and 0.7 version).dta", replace
    ...
    ** PCAs
    ...
    save "${pca_drive}\pca_10D - only matched records - no exact match on grant year (lam 0.6 and 0.7 version).dta", replace
