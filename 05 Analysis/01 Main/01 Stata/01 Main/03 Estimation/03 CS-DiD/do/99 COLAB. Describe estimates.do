...
* ==============================================================================
    ...
    ** Start log
    log using "${log}/99 COLAB. Describe estimates.log", replace
    timer clear 1
    timer on 1
...
********************************************************************************
    ...
    ** Get the ster files in the out folder
    local csv_es_files : dir "${out}\est" files "*event study.csv", respectcase
        ...
        qui{    
            preserve
                ...
                ** Destring 
                ...
                replace posttreatment_periods = subinstr(posttreatment_periods, "- event study.csv", "", .)
            ...
            preserve
                ...
                ** Load the ster file
                import delimited using  "${out}\est\\`f'", clear
                sort event_time
...
********************************************************************************    
    ...
    ** Save final results
    save "${dta}\CSDID Estimates Summary (COLAB, Cross Section estimates).dta", replace
    awds