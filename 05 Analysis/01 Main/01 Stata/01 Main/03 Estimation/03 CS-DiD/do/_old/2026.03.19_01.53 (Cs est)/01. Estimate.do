...
* ==============================================================================
    ...
    ** Start log
    log using "${log}/01. Estimate.log", replace
    timer clear 1
    timer on 1
            ...
            foreach caliper of local calipers {
                foreach lambda of local lambdas {
                    ...
                    ** Skip if already estimated
                    ...
                    local est_filename = subinstr("`filename'", "01 Sample", "01 CSDID Estimates", .)
                ...
                * ==============================================================================
                    ...
                    ** Run csdid
                    ...
                    csdid log_citation age* pc* i.grant_year i.cpc, i(patent_id) g(cohort) t(quarter) method(reg) seed(`seed') 
