...
* ==============================================================================
    ...
    ** Start log
    log using "${log}/03. Estimate - M&A.log", replace
    timer clear 1
    timer on 1
            ...
            foreach caliper of local calipers {
                foreach lambda of local lambdas {
                    ...
                    ** Skip if already estimated
                    ...
                    local est_filename = subinstr("`filename'", "01 Sample", "03 CSDID Estimates", .)
                ...
                * ==============================================================================
                    ...
                    ** Drop treated patents for which we cannot observe the full post-treatment period (11q in this case)
                ...
                * ==============================================================================
                    ...
                    ** Run csdid
                    ...
                    if `lambda' == 1 {
                        di in red "Estimating CS-DiD without PCA controls"
