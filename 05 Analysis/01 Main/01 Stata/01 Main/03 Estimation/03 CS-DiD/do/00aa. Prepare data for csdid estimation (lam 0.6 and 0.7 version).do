...
* ==============================================================================
    ...
    ** Locals
    local list_of_maximum_periods 12  // quarters (i.e. 3, 4, 5, 10 years)
    local seed = 1709
...
* ==============================================================================
    ...
    ** Save intermediary
    ...
    save "${dta}\00aa Sample - without citations - no exact matching on grant year (lambda 0.6 and 0.7).dta", replace