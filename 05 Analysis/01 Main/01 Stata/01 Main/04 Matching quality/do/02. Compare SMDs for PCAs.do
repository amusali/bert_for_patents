...
* ==============================================================================
    ** Load and get config from source file
    import delimited using "${out}/00 Before SMDs PCAs.csv",  clear

    ** Config 
    rename config source
    ...
    ** Rename
    ...
    keep acq_type bl_tt base_tt_threshold pre_treatment_period smd* cov

    ** Reshape
    reshape wide *smd*, i(acq_type bl_tt base_tt_threshold pre_treatment_period) j(covariate) str
    rename *PC* *pc*
...
* ==============================================================================
    ...
    keep if pre == 4
    append using "${out}\01 After SMDs - PCAs.dta"
