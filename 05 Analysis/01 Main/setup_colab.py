...
try:
    ...
    # Try decoding as UTF-8 with BOM handling first
    try:
        content = content.decode('utf-8-sig')
    except UnicodeDecodeError:
        # If UTF-8 decoding fails, fallback to ISO-8859-1
        print("Failed to decode as UTF-8, trying ISO-8859-1")
        content = content.decode('ISO-8859-1')

    # Split lines to get the package requirements
